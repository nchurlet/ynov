...
public class ApiHelpers {
    ...
    public void getForecastByIdAsync(long cityid, ApiRequestCallback<List<Weather>> callback) {
        (new ApiRequest<List<Weather>>()).requestAsync(apiservice.getForecastById(cityid, API_KEY), callback);
    }
    // endregion Lists
    // region By id
    // endregion By id
